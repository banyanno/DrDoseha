...
Public Class CrpPrescriptionV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CrpPrescriptionV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpPrescriptionV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpPrescriptionV1 = New CrpPrescriptionV1
        rpt.Site = Me.Site
        Return rpt
    End Function
