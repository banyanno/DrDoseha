...
Public Class CRVCertificatev1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CRVCertificatev1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVCertificatev1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVCertificatev1 = New CRVCertificatev1
        rpt.Site = Me.Site
        Return rpt
    End Function
