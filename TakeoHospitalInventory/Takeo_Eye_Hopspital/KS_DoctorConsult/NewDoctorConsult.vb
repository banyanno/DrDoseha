...
Public Class NewDoctorConsult
    ...
    Private Sub ViewPatientPrescrip()
        ...
        Else
            ' GenerateReportKhmer("select * from V_EYE_PRESCRIPTION WHERE WAIT_ID =" & WAITING_NO, Application.StartupPath & "\CrpPrescriptionV1.rpt")
            ...
            'fReport.AxCrystalActiveXReportViewer1.ReportSource = myReportObj.Report
            'fReport.AxCrystalActiveXReportViewer1.ViewReport()
            'fReport.AxCrystalActiveXReportViewer1.Zoom(100)
            'fReport.ShowDialog()
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        ...
        If ChLaborat.Checked = True Then
            ...
            End If
        End If
        If ValidateCombobox(CboDiagnosis, "", ErrConsult) = False Then Exit Sub
        ...
        If IS_UPDATE_CONSULT = True Then
            ...
            If MessageBox.Show("Do you want to edit examination?", "Consult", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                'Update Main Consult 
                DA_Consult.UpdateConsultationID(1, TxtDiagnosisCode.Text, CboDiagnosis.Text, IS_Diagnosis, TxtDiagnosisNote.Text, IS_Management, _
        ...
        Else
            ...
            If MessageBox.Show("Do you want to save new examination?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                If DA_Consult.InsertNewConsult(WAITING_NO, TxtPatientNo.Text, 0, TxtDiagnosisCode.Text, _
                                               CboDiagnosis.Text, CboEyes.Text, TxtDiagnosisNote.Text, IS_Management, TxtMedication.Text, _
                                               CboDoctorConsult.Text, ChIssueGlasses.Checked, CboSurgery.Text, ChConsultFree.Checked) = 1 Then
                    ...
                    DA_DoctorConsult.InsertNewDoctorConsult(CInt(CboDoctorConsult.SelectedValue), CboDoctorConsult.Text, Now.Date, _
                                                            TxtPatientNo.Text, TxtNameEng.Text, TxtNameKhmer.Text, CboSexPatien.Text, CboEyes.Text, _
                                                            CboDiagnosis.Text, IS_Management, CboSurgery.Text, CDbl(IIf(ChConsultFree.Checked = True, 0, CDbl(CboExamFee.SelectedValue))), _
                                                            EmptyString(TxtPriceSurgery.Text), CBool(IIf(ChConsultFree.Checked = True, True, False)), CboExamFee.Text, _
                                                            CDbl(IIf(ChLaser.Checked = False, 0, TotalLaser)))
