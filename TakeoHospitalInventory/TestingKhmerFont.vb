...
Public Class TestingKhmerFont
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.TestingKhmerFont.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestingKhmerFont
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestingKhmerFont = New TestingKhmerFont
        rpt.Site = Me.Site
        Return rpt
    End Function
